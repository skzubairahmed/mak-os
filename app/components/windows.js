...
export default function Window({title, children, onClose}){
    ...
    return(
        <Draggable nodeRef={nodeRef} handle=".window-header" bounds="parent" grid>
            <div ref={nodeRef} className="absolute top-20 left-20 w-[400px] bg-zinc-900/90 backdrop-blur-md border border-white/20 rounded-lg shadow-2xl flex flex-col overflow-hidden">
                ...
                <div className="p-4 text-white h-[300px] overflow-y-auto custom-scrollbar">
                    {children}
                </div>
            </div>
        </Draggable>
